...
namespace DDACAssignment.Migrations
{
    ...
    [Migration("20251104005923_UpdateRequestField")]
    partial class UpdateRequestField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DDACAssignment.Models.Request.Request", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DDACAssignment.Models.Request.ApplyRequest", b =>
                {
                    b.HasBaseType("DDACAssignment.Models.Request.Request");

                    b.Property<string>("OrganizationName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.HasDiscriminator().HasValue("ApplyRequest");
                });

            modelBuilder.Entity("DDACAssignment.Models.Request.PromoteRequest", b =>
                {
                    b.HasBaseType("DDACAssignment.Models.Request.Request");
                    ...
                    b.HasDiscriminator().HasValue("PromoteRequest");
                });
            ...
            modelBuilder.Entity("DDACAssignment.Models.Admin", b =>
                {
                    b.HasOne("DDACAssignment.Models.User", "User")
                        .WithOne("Admin")
                        .HasForeignKey("DDACAssignment.Models.Admin", "Id")
            ...
            modelBuilder.Entity("DDACAssignment.Models.Organizer", b =>
                {
                    b.HasOne("DDACAssignment.Models.User", "User")
                        ...
                        .HasForeignKey("DDACAssignment.Models.Organizer", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DDACAssignment.Models.Personnel", b =>
                {
                    b.HasOne("DDACAssignment.Models.User", "User")
                        ...
                        .HasForeignKey("DDACAssignment.Models.Personnel", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DDACAssignment.Models.PlayerPerformance", b =>
                {
                    b.HasOne("DDACAssignment.Models.Player", "Player")
                        .WithOne("PlayerPerformance")
                        .HasForeignKey("DDACAssignment.Models.PlayerPerformance", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DDACAssignment.Models.TeamStatistic", b =>
                {
                    b.HasOne("DDACAssignment.Models.Team", "Team")
                        .WithOne("TeamStatistic")
                        .HasForeignKey("DDACAssignment.Models.TeamStatistic", "TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DDACAssignment.Models.Player", b =>
                {
                    b.Navigation("PlayerPerformance");
                });
